#!/usr/bin/env python3
"""
CFB_RECEIVING_TOUCHDOWNS_CHAMPION_GATE_A

First honest CFB receiving-touchdowns (anytime-TD) model, direct
binary:logistic classifier. Predictions-first: no odds. WR-only,
ALL-DIVISION population (see clean_baseline for why Power4 scoping
wasn't assumed to be needed here just because receiving_yards needed
it).
...
BASELINE_DEFAULT = "/data/cfb_model/cfb_receiving_touchdowns_clean_baseline_a_work/baseline.sqlite"
WORKDIR_DEFAULT = "/data/cfb_model/cfb_receiving_touchdowns_champion_gate_a_work"
...
def main():
    ...
    print("CFB_RECEIVING_TOUCHDOWNS_CHAMPION_GATE_A\n=========================================")
    ...
    report = {"script": "CFB_RECEIVING_TOUCHDOWNS_CHAMPION_GATE_A", "holdout": HOLDOUT_SEASON,
    ...
    (work / "cfb_receiving_touchdowns_champion_gate_a_report.json").write_text(json.dumps(report, indent=2))
