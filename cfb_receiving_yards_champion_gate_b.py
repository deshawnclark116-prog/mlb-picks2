#!/usr/bin/env python3
"""
CFB_RECEIVING_YARDS_CHAMPION_GATE_B
...
BASELINE_DEFAULT = "/data/cfb_model/cfb_receiving_yards_clean_baseline_b_work/baseline.sqlite"
WORKDIR_DEFAULT = "/data/cfb_model/cfb_receiving_yards_champion_gate_b_work"
...
def main():
    ...
    print("CFB_RECEIVING_YARDS_CHAMPION_GATE_B\n====================================")
    ...
    report = {"script": "CFB_RECEIVING_YARDS_CHAMPION_GATE_B", "holdout": HOLDOUT_SEASON,
