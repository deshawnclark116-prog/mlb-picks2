#!/usr/bin/env python3
"""
CFB_RECEIVING_YARDS_CHAMPION_GATE_A

First honest CFB receiving-yards model, direct binary:logistic classifier.
Predictions-first: no odds. WR-only population (see clean_baseline).
...
Run
---
python -u cfb_receiving_yards_champion_gate_a.py
"""
...
BASELINE_DEFAULT = "/data/cfb_model/cfb_receiving_yards_clean_baseline_a_work/baseline.sqlite"
WORKDIR_DEFAULT = "/data/cfb_model/cfb_receiving_yards_champion_gate_a_work"
...
def main():
    ...
    print("CFB_RECEIVING_YARDS_CHAMPION_GATE_A\n====================================")
    ...
    report = {"script": "CFB_RECEIVING_YARDS_CHAMPION_GATE_A", "holdout": HOLDOUT_SEASON,
              "constant": constant, "challenger": challenger, "gate": GATE,
              "passed": passed, "verdict": verdict, "importance": imp,
              "best_iteration": bst.best_iteration}
    (work / "cfb_receiving_yards_champion_gate_a_report.json").write_text(json.dumps(report, indent=2))
