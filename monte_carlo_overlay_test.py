...
def analyze_candidate(row: Dict[str, Any], rng: Any, sim_n: int, min_mc_prob: float, hr_min_mc_prob: float) -> Dict[str, Any]:
...
def main() -> int:
    ...
    ap.add_argument("--min-mc-prob", type=float, default=0.63, help="Keep threshold for non-HR markets. Accepts 0.63 or 63.")
    ...
    rows = [analyze_candidate(r, rng, sim_n, min_mc_prob, hr_min_mc_prob) for r in candidates]
