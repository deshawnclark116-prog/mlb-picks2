#!/usr/bin/env python3
"""
CFB_PASSING_YARDS_CLEAN_BASELINE_A
...
Run
---
python -u cfb_passing_yards_clean_baseline_a.py
"""
...
WORKDIR_DEFAULT = "/data/cfb_model/cfb_passing_yards_clean_baseline_a_work"
...
def build_rows(conn):
    ...
    rows = conn.execute("""
        SELECT player_id, player_name, team, opponent, season, week,
               is_home, pass_attempts, passing_yards
        FROM player_games
        WHERE position = 'QB'
    ...
    def flush(group):
        ...
        for r in group:
            pid, pname, team, opp, season, week, is_home, attempts, pass_yards = r
            a3 = list(att_hist)[-3:]
...
def main():
    ...
    print("CFB_PASSING_YARDS_CLEAN_BASELINE_A\n===================================")
    print(f"source={src}\nworkdir={work}\nline={LINE}")
    ...
    manifest = {
        "script": "CFB_PASSING_YARDS_CLEAN_BASELINE_A",
