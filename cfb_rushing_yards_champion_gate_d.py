#!/usr/bin/env python3
"""
CFB_RUSHING_YARDS_CHAMPION_GATE_D
...
BASELINE_DEFAULT = "/data/cfb_model/cfb_rushing_yards_clean_baseline_b_work/baseline.sqlite"
WORKDIR_DEFAULT = "/data/cfb_model/cfb_rushing_yards_champion_gate_d_work"
...
# gate_d: more conservative than gate_b2 (shallower trees, heavier leaf/L2
# regularization, slower learning rate) -- ~1450 training rows is a small
# regime for XGBoost; deeper/faster-fit trees can produce overconfident,
# jagged probability estimates that Platt scaling (already shown not to
# help here) can't smooth out after the fact. Different technique: prevent
# the overconfidence at training time instead of correcting it post-hoc.
NAN = float("nan")
...
def main():
    ...
    print("CFB_RUSHING_YARDS_CHAMPION_GATE_D\n=================================")
    ...
    report = {"script": "CFB_RUSHING_YARDS_CHAMPION_GATE_D", "holdout": HOLDOUT_SEASON,
