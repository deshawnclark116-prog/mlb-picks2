#!/usr/bin/env python3
"""
CFB_PASSING_YARDS_CHAMPION_GATE_B
...
WORKDIR_DEFAULT = "/data/cfb_model/cfb_passing_yards_champion_gate_b_work"
...
def main():
    ...
    print("CFB_PASSING_YARDS_CHAMPION_GATE_B\n==================================")
    ...
    report = {"script": "CFB_PASSING_YARDS_CHAMPION_GATE_B", "holdout": HOLDOUT_SEASON,
