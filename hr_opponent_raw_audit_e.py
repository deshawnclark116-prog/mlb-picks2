...
Run:
    python hr_opponent_raw_audit_e.py --rebuild
"""
...
def load_df(pd, conn):
    ...
    for c in df.columns:
        if c not in ("game_id", "batter_name", "stand", "p_throws", "first_pitcher_role"):
