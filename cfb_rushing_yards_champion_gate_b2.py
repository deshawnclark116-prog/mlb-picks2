#!/usr/bin/env python3
"""
CFB_RUSHING_YARDS_CHAMPION_GATE_B2
...
WORKDIR_DEFAULT = "/data/cfb_model/cfb_rushing_yards_champion_gate_b2_work"
...
def main():
    ...
    print("CFB_RUSHING_YARDS_CHAMPION_GATE_B2\n=================================")
    ...
    report = {"script": "CFB_RUSHING_YARDS_CHAMPION_GATE_B2", "holdout": HOLDOUT_SEASON,
