#!/usr/bin/env python3
"""
CFB_RUSHING_YARDS_CHAMPION_GATE_B
...
import cfb_rushing_yards_champion_gate_a as g
...
def main():
    ...
    print("CFB_RUSHING_YARDS_CHAMPION_GATE_B\n==================================")
    ...
    report = {"script": "CFB_RUSHING_YARDS_CHAMPION_GATE_B", "holdout": g.HOLDOUT_SEASON,
